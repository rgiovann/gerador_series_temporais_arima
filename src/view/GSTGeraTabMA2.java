...
public class GSTGeraTabMA2 extends JPanel   implements PropertyChangeListener {
	...
	private static String MAPar2String = "Valor de " + "\u03B8"+"2    |"+ "\u03B8"+"2"+"| <1      : ";
	...
	public GSTGeraTabMA2() {
		...
		MAPar2Label = new JLabel(MAPar2String);
		...
		MAPar2Field = new JFormattedTextField(MAPar2Format);
		MAPar2Field.setValue(new Double(MAPar2));
		MAPar2Field.setColumns(5);
		MAPar2Field.addPropertyChangeListener("value", this); 
		...
		MAPar2Label.setLabelFor(MAPar2Field);
	...
	else if (source == MAPar2Field) {
	MAPar2 = ((Number)MAPar2Field.getValue()).doubleValue();
	}
	else if 
	...
	private void setUpFormats() {
	    ...
	    MAPar2Format = NumberFormat.getNumberInstance();
